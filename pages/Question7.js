...
const Question = ( {navigation} ) => {
    ...
    const image = { uri: "https://firebasestorage.googleapis.com/v0/b/test-app-81395.appspot.com/o/images%2Fback7.jpg?alt=media&token=94474a85-11ab-487d-ac2c-0f15f62cf4a0" };
    ...
    useEffect(() => {
        ...
        firebase_db.ref('/question').once('value').then((snapshot) => {
          console.log("파이어베이스에서 Q7 데이터 입수")
          let question =snapshot.val();
          setQuestionState(question[6])
          setReady(false)
        })
    }, [])
        ...
        <View style={styles.container}>
            ...
            <View style={styles.answerList}>
                ...
                <View style={styles.buttonGroup}>
                   ...
                   <TouchableOpacity style={styles.button02} onPress={() => navigation.navigate('Question8')}>
