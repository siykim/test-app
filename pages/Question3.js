...
const Question = ( {navigation} ) => {
    ...
    const image = { uri: "https://firebasestorage.googleapis.com/v0/b/test-app-81395.appspot.com/o/images%2Fback3.jpg?alt=media&token=a84c5813-e11e-44ff-ba65-22feb8f4eb7d" };
    ...
    useEffect(() => {
        ...
        firebase_db.ref('/question').once('value').then((snapshot) => {
          console.log("파이어베이스에서 Q3 데이터 입수")
          let question =snapshot.val();
          setQuestionState(question[2])
          setReady(false)
        })
    }, [])
        ...
        const goResult = (data) => {
          ...
          if (data.idx == 1) {
            ...
            navigation.navigate('ExplainPage01')
          } else if (data.idx == 2) {
            firebase_db.ref('history/'+ user_id +'/' + questionState.idx).set(new_history)
            navigation.navigate('ExplainPage01')
          } else if (data.idx == 3) {
        ...
        <View style={styles.container}>
            ...
            <View style={styles.answerList}>
                ...
                <View style={styles.buttonGroup}>
                   ...
                   <TouchableOpacity style={styles.button02} onPress={() => navigation.navigate('ExplainPage01')}>
