...
const Question = ( {navigation} ) => {
  ...
  const image = { uri: "https://firebasestorage.googleapis.com/v0/b/test-app-81395.appspot.com/o/images%2Fback2.png?alt=media&token=588522ab-2b3c-48a6-a55e-ed303bbab5df" };
    ...
    useEffect(() => {
        ...
        firebase_db.ref('/question').once('value').then((snapshot) => {
          console.log("파이어베이스에서 Q2 데이터 입수")
          let question =snapshot.val();
          setQuestionState(question[1])
          setReady(false)
        })
    }, [])
        ...
        <View style={styles.container}>
            ...
            <View style={styles.answerList}>
                ...
                <View style={styles.buttonGroup}>
                   ...
                   <TouchableOpacity style={styles.button02} onPress={() => navigation.navigate('Question3')}>
