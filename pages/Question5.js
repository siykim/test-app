...
const Question = ( {navigation} ) => {
    ...
    const image = { uri: "https://firebasestorage.googleapis.com/v0/b/test-app-81395.appspot.com/o/images%2Fback5.jpg?alt=media&token=a2cff099-4b2b-4378-8620-ae6360e5ecff" };
    ...
    useEffect(() => {
        ...
        firebase_db.ref('/question').once('value').then((snapshot) => {
          console.log("파이어베이스에서 Q5 데이터 입수")
          let question =snapshot.val();
          setQuestionState(question[4])
          setReady(false)
        })
    }, [])
        ...
        <View style={styles.container}>
            ...
            <View style={styles.answerList}>
                ...
                <View style={styles.buttonGroup}>
                   ...
                   <TouchableOpacity style={styles.button02} onPress={() => navigation.navigate('Question6')}>
